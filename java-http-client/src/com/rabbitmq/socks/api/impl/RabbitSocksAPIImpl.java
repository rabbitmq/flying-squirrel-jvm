...
public class RabbitSocksAPIImpl implements RabbitSocksAPI
{
    ...
    public void createEndpoint(final Endpoint endpoint) throws Exception
    {
    ...
    public Endpoint getEndpoint(final String endpointName) throws Exception
    {
    ...
    public void deleteEndpoint(final String endpointName) throws Exception
    {
        String uri = endpointURL + endpointName;
    ...
    public List<String> listEndpointNames() throws Exception
    {
    ...
    public String generateTicket(final String endpointName,
            final String identity, final long timeout) throws Exception
    {
    ...
    private HttpURLConnection doRequest(final String uri, final String method,
            final boolean contentType) throws Exception
    {
        URL url = new URL(uri);
    ...
    private Reader createReader(final HttpURLConnection conn) throws Exception
    {
        return new BufferedReader(new InputStreamReader(conn.getInputStream()));
    }

    private Writer createWriter(final HttpURLConnection conn) throws Exception
    {
    ...
    //debug
    private void dumpReader(Reader rdr) throws Exception
    {
        int b = -1;
